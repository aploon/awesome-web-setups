                ...
                <div className="h-16 flex items-center justify-between border-b border-white/5">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a
                            ...
                            aria-label="Discord"
                        >
                            <svg className="w-7 h-7" fill="#98989f" xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" width="90px" height="90px" fill-rule="nonzero">
                                <g fill="" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none">
