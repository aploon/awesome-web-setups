...
export function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/80 dark:bg-black/20">
            <div className="max-w-7xl mx-auto px-6">
                <div className="h-16 flex items-center justify-between border-b border-gray-200 dark:border-white/5">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <span
                                className={`absolute left-1 top-1 w-5 h-5 rounded-full flex items-center justify-center transition-transform duration-200 bg-white dark:bg-white/10 text-gray-600 dark:text-white/80 ${isDarkMode ? '' : 'translate-x-5'}`}
                            >
                        ...
                        <a
                            href="https://github.com/aploon/awesome-web-setups"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-500 hover:text-gray-900 dark:text-white/50 dark:hover:text-white/90 transition-colors"
                        >
                        ...
                        <a
                            href="https://discord.gg/yMb8knqN"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-gray-500 hover:text-gray-900 dark:text-white/50 dark:hover:text-white/90 transition-colors"
                            aria-label="Discord"
                        >
                            <svg className="w-7 h-7" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" width="90px" height="90px" fillRule="nonzero">
